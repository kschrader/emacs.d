#+TITLE: Kurt Schrader's Emacs 24 Configuration
...
*** Install default packages
    ...
    in =kschrader/packages= are installed. If not, have ELPA take care of
    it.
    #+begin_src emacs-lisp
...
*** Display Settings
    ...
    the left hand side. I also like to see Git changes in the gutter
    #+begin_src emacs-lisp
      (when window-system
...
*** JavaScript Mode
    ...
    #+end_src
*** Clojure and Cider
    Make Clojure and Cider a bit more usable
    #+begin_src emacs-lisp
